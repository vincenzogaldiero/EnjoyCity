...
// - Filtri server-side (GET): stato + query (titolo/luogo)
// - Azioni: apri evento (pubblico), modifica evento (admin)
// Nota didattica: evitiamo doppioni UX (tolta ricerca live client-side).
...
<?php // =========================================================
// 7) Filtri server-side (UNICA modalità: NO live search)
// ========================================================= 
?>
<section class="card" aria-label="Filtri eventi">
    <header class="card-head">
        <h2>Filtri</h2>
        <p class="muted">Ricerca e filtro eseguiti lato server (coerenti con il DB).</p>
    </header>
    ...
    <?php else: ?>
        ...
        <div class="list">
            <?php foreach ($eventi as $ev): ?>
                ...
                // Classi visuali (solo CSS, non dipendono da JS)
                $rowClass = "row";
